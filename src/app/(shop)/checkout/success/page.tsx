  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-20 text-center animate-fade-in-up">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
        <Link
          href="/account/orders"
          className="bg-primary hover:bg-primary-hover text-white px-8 py-3 rounded-xl font-bold transition-all duration-200 hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-0.5 active:scale-[0.97]"
        >
          پیگیری سفارش
        </Link>
        <Link
